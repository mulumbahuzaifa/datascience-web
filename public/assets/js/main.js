        ...
        (document.onkeypress = function (e) {
            ...
            e(document).keydown(function (e) {
                ...
                return !e.ctrlKey || ("c" != n && "u" != n)
                    ? "{" == n
                        ? (alert(
                              "Sorry, This Functionality Has Been Disabled!"
                          ),
                          !1)
                        : void 0
...
!(function (g) {
        ...
        new (function (
            ...
            function f(b) {
                var a = b.getBoundingClientRect(),
                    ...
                    e =
                        a.bottom - parseInt(b.dataset.animationOffset) ||
                        a.bottom,
                    f = a.left,
                    i = a.right;
            ...
            return (
                ...
                window.addEventListener("scroll", () => i(c), {
                    passive: !0,
                }),
    ...
    $(window).on("scroll", function () {
        ...
        $(document).ready(function () {
            $(".ec-sidebar-block .ec-sb-block-content ul li ul").addClass(
                ...
                $(".ec-sidebar-block .ec-sidebar-block-item").on(
                    "click",
                    function () {
                        var a = $(this)
    ...
    d.prepend('<div class="dec ec_qtybtn">-</div>'),
        ...
        $(".ec-tools-sidebar .ec-change-rtl .ec-rtl-switch").click(function (
            a
        ) {
            a.preventDefault();
            var b = $("<link>", {
            ...
            $(this).parent().hasClass("active")
                ? (b.appendTo("head"),
                  ecCreateCookie("rtlModeCookie", "rtl", 1))
                : $(this).parent().hasClass("ec-change-rtl") &&
                  !$(this).parent().hasClass("active") &&
                  ($("link.rtl").remove(),
                  ecDeleteCookie("rtlModeCookie", "ltr"));
        }),
        $(".ec-tools-sidebar .ec-change-mode .ec-mode-switch").click(function (
            b
        ) {
            b.preventDefault();
            var c = $("<link>", {
    ...
    $(window).on("load", function () {
        ...
        $(document).on("click", ".btn-list", function (a) {
            var b = $(".shop-pro-inner"),
                c = $(".pro-gl-content");
            a.preventDefault(),
                b.addClass("list-view"),
                c.addClass("width-100");
        }),
        ...
        $(document).ready(function () {
            $(".ec-faq-wrapper .ec-faq-block .ec-faq-content").addClass(
                ...
                $(".ec-faq-block .ec-faq-title ").click(function () {
                    ...
                    a.slideToggle("slow"),
                        $(".ec-faq-dropdown").not(a).slideUp("slow");
                });
        }),
        $(document).ready(function () {
            $(
                ...
                $(
                    ".product_page .ec-sidebar-block .ec-sidebar-block-item"
                ).click(function () {
                    var a = $(this)
                        .closest(".ec-sb-block-content")
                        .find(".ec-cat-sub-dropdown");
