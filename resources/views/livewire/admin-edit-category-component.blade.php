                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <form action="" class="form-horizontal" wire:submit.prevent="updateCategory">
                            ...
                            <div class="form-group">
                                <label for="" class="col-md-8 control-lable">Category Icon</label>
                                <div class="col-md-8">
                                    <input type="file"  class="input-file" wire:model="newIcon">
                                    @if($newIcon)
                                        <img src="{{ $newIcon->temporaryUrl() }}" width="120" alt="">

                                    @else
                                        <img src="{{ asset('assets/images/icons') }}/{{ $icon }}" width="120" alt="">

                                    @endif
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-md-8 control-lable">Category Image</label>
                                <div class="col-md-8">
