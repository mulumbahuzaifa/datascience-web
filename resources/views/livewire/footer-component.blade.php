<div>
                            ...
                            <div class="ec-footer-widget">
                                ...
                                <div class="ec-footer-links">
                                    <ul class="align-items-center">
                                        <li class="ec-footer-link">Our clients know us as a reliable, trusted and most robust online shopping site.</li>
                                        <li class="ec-footer-link"><span>Call Us:</span><a href="tel:{{ $setting->phone }}">{{ $setting->phone }}</a></li>
                                        @if ($setting->phone2)
                                        <li class="ec-footer-link"><span> OR Call Us:</span><a href="tel:{{ $setting->phone2 }}">{{ $setting->phone2 }}</a></li>
                                        @endif
                                        <li class="ec-footer-link"><span>Email:</span><a href="mailto:{{ $setting->email }}">{{ $setting->email }}</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="ec-footer-widget">
                                ...
                                <div class="ec-footer-links">
                                    <ul class="align-items-center">
                                        ...
                                        <li class="ec-footer-link"><a href="route('offers')">Specials</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="ec-subscribe-form">
                                        <form id="ec-newsletter-form" name="ec-newsletter-form" method="post" action="#">
                                            <div id="ec_news_signup" class="ec-form">
                                                ...
                                                <button id="ec-news-btn" class="button btn-primary" type="submit" name="subscribe" value=""><i class="ecicon eci-paper-plane-o"
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col text-left footer-bottom-left">
                            <div class="footer-bottom-social">
                                ...
                                <ul class="mb-0">
                                    <li class="list-inline-item"><a class="hdr-facebook" href="{{ $setting->facebook }}" target="_blank"><i class="ecicon eci-facebook"></i></a></li>
                                    <li class="list-inline-item"><a class="hdr-twitter" href="{{ $setting->twitter  }}" target="_blank"><i class="ecicon eci-twitter"></i></a></li>
                                    <li class="list-inline-item"><a class="hdr-instagram" href="{{ $setting->instagram  }}" target="_blank"><i class="ecicon eci-instagram"></i></a></li>
                                    <li class="list-inline-item"><a class="hdr-linkedin" href="{{ $setting->linkedIn  }}" target="_blank"><i class="ecicon eci-linkedin"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- Footer social End -->
                        ...
                        <div class="col text-center footer-copy">
                            <div class="footer-bottom-copy ">
                                <div class="ec-copy">Copyright © 2022 <a class="site-name text-upper" href="http://rcsconsult.net" target="_blank">RCS CONSULT LTD<span>.</span></a>. All Rights Reserved</div>
                            </div>
                        </div>
            ...
            <div class="ec-nav-panel">
                <div class="ec-nav-panel-icons">
                    <a href="#ec-mobile-menu" class="navbar-toggler-btn ec-header-btn ec-side-toggle"><img
                            src="{{ asset('assets/images/icons/menu.svg') }}" class="svg_img header_svg" alt="icon" /></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="#ec-side-cart" class="toggle-cart ec-header-btn ec-side-toggle"><img
                            src="{{ asset('assets/images/icons/cart.svg') }}" class="svg_img header_svg" alt="icon" /><span
                ...
                <div class="ec-nav-panel-icons">
                    <a href="{{ route('wishlist') }}" class="ec-header-btn"><img src="{{ asset('assets/images/icons/wishlist.svg') }}"
    ...
    <div class="ec-cart-float">
        <a href="#ec-side-cart" class="ec-header-btn ec-side-toggle">
            <div class="header-icon"><img src="{{ asset('assets/images/icons/cart.svg') }}" class="svg_img header_svg" alt="cart" />
            </div>
                        ...
                        <a class="ec-list" data-number="918866774266" data-message="Please help me! I have got wrong product - ORDER ID is : #654321485">
                            <div class="d-flex bd-highlight">
                                ...
                                <div class="ec-img-cont">
                                    <img src="{{ asset('assets/images/whatsapp/profile_01.jpg') }}" class="ec-user-img" alt="Profile image">
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266" data-message="Please help me! I have got wrong product - ORDER ID is : #654321485">
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="{{ asset('assets/images/whatsapp/profile_02.jpg') }}" class="ec-user-img" alt="Profile image">
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266" data-message="Please help me! I have got wrong product - ORDER ID is : #654321485">
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="{{ asset('assets/images/whatsapp/profile_03.jpg') }}" class="ec-user-img" alt="Profile image">
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266" data-message="Please help me! I have got wrong product - ORDER ID is : #654321485">
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="{{ asset('assets/images/whatsapp/profile_04.jpg') }}" class="ec-user-img" alt="Profile image">
                                    <span class="ec-status-icon ec-offline"></span>
                                </div>
                                <!-- Display Name & Last Seen -->
                                <div class="ec-user-info">
